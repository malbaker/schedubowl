...
* The original package name 'com.example.bowling-example' is invalid and this project uses 'com.example.bowlingexample' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/2.5.12/reference/htmlsingle/#boot-features-mongodb)
